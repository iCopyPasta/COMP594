    ...
    def generateNewImageWithTensor(self,centerShldrWidth,laneCount,laneWidth,lineWidth,shoulderWidth):
        ...
        for i in range(laneCount):
            ...
            if i == 0:
                ...
                self.drawStraightLine(imgMap,start,lineWidth,200,40,200,40,200,40,20,20, "white-lane-markers")
            
            #move over a white-lane-markers line
            start += lineWidth 
            
            #DRAW our lane
            self.drawStraightLine(imgMap,start,laneWidth,128,40,128,40,128,40,0,0, "lane")
